...
using SchedulingSystemClassLibrary.ViewModels.Api;
using SchedulingSystemWeb.Results;
...
namespace SchedulingSystemWeb.Controllers.Api
{
    public class AccountController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Register(RegisterBindingModel model)
        {
            ...
            result = await UserManager.AddToRoleAsync(user.Id, RoleName.IsAStudent);

            if (result.Succeeded)
            {
                model.Student.AccountId = user.Id;
